;; gameweave-registry
;; This contract serves as the central hub for the GameWeave ecosystem, maintaining a comprehensive
;; registry of all NFTs that can operate across different games. It stores essential metadata about
;; each NFT, including its origin game, trait categories, capability definitions, and conversion
;; rules for how the asset should be represented in different gaming environments.
